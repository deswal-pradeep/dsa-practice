...
public class LC_17_3761_minimumAbsoluteDistanceBetweenMirrorPairs {
    //https://leetcode.com/problems/minimum-absolute-distance-between-mirror-pairs/?envType=daily-question&envId=2026-04-17
    static void main() {
        int ans  = new LC_17_3761_minimumAbsoluteDistanceBetweenMirrorPairs().minMirrorPairDistance(new int[]{120,21});
