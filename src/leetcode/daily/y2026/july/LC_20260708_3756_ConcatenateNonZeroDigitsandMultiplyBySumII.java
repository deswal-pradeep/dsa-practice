...
public class LC_20260708_3756_ConcatenateNonZeroDigitsandMultiplyBySumII {
    ...
    static void main() {
        int[] ans = new LC_20260708_3756_ConcatenateNonZeroDigitsandMultiplyBySumII()
                .sumAndMultiply("83653355979889175588", new int[][]{{0,19}});

        int[] ans1 = new LC_20260708_3756_ConcatenateNonZeroDigitsandMultiplyBySumII()
